...
class EventAddNewSpotFill extends StatefulWidget {
  EventAddNewSpotFill(this.spotModal, this.images, this.imageTypes);
  SpotModel spotModal;
  List images;
  List imageTypes;
  @override
  _EventAddNewSpotFillState createState() => _EventAddNewSpotFillState();
}

class _EventAddNewSpotFillState extends State<EventAddNewSpotFill> {
