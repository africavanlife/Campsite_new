...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_share_me/flutter_share_me.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/simple_auth_flutter/simple_auth_flutter.framework"
